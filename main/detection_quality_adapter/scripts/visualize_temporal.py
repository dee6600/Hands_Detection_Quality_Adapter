...
Usage (run from `main/detection_quality_adapter/`):
    ...
    python main/detection_quality_adapter/scripts/visualize_temporal.py data/407258cd_t036 main/detection_quality_adapter/scripts/tmp/out4_2.mp4 --max-frames 300
"""
