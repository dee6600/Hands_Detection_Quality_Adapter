...
Usage (run from `main/detection_quality_adapter/`):
    ...
    python main/detection_quality_adapter/scripts/visualize_stage1.py data/42bba884_t012 main/detection_quality_adapter/scripts/tmp/out2.mp4 --max-frames 300
